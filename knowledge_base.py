...
class KnowledgeBaseService(object):
    def __init__(self):
        ...
        self.chroma = Chroma(
            ...
            embedding_function=DashScopeEmbeddings(model=config.embedding_model_name,dashscope_api_key=config.DASHSCOPE_API_KEY),
    ...
    def upload_by_str(self, data: str, filename):
        ...
        try:
            ...
            # 写入失败直接返回，不保存MD5，不影响原有返回逻辑
            return f"[失败]向量写入异常: {e}"
